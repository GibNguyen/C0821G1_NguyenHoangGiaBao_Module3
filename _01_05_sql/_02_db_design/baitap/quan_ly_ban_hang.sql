...
CREATE TABLE `order` (
  ...
  `odder_total_price` double DEFAULT NULL,
...
CREATE TABLE `order_detail` (
  `order_id` int NOT NULL,
  `pro_id` int NOT NULL,
  `order_quanlity` int DEFAULT NULL,
  PRIMARY KEY (`order_id`,`pro_id`),
  KEY `pro_id` (`pro_id`),
  CONSTRAINT `order_detail_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `order` (`order_id`),
  CONSTRAINT `order_detail_ibfk_2` FOREIGN KEY (`pro_id`) REFERENCES `product` (`pro_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-11-15 15:12:43
